...
const Sprint: FunctionComponent<propTypes> = ({}: propTypes) => {
  ...
  const [createSprint, { data: newSprint, loading: isCreatingSprint }] = useMutation<{ createSprint: SprintType }>(mutations.createSprint, cacheUpdates.saveNewSprint);

  if (isFetchingSprints)
